...
var _imagesApiService = require("./js/ImagesApiService");
var _imagesApiServiceDefault = parcelHelpers.interopDefault(_imagesApiService);
var _loadMoreButton = require("./js/LoadMoreButton");
var _loadMoreButtonDefault = parcelHelpers.interopDefault(_loadMoreButton);
var _buildGalleryMarkup = require("./js/buildGalleryMarkup");
const refs = {
...
const imagesApiService = new (0, _imagesApiServiceDefault.default)();
const loadMoreBtn = new (0, _loadMoreButtonDefault.default)({
    selector: ".load-more"
});
...
async function onFormSubmit(event) {
    ...
    if (imagesApiService.query === "") {
        (0, _notiflixNotifyAio.Notify).failure("Please, enter a search term!");
        return;
    }
    await fetchImages();
    gallery = new (0, _simplelightboxDefault.default)(".gallery a", {
        showCounter: false,
        captionsData: "alt",
        captionDelay: 300
    });
...
function fetchImages() {
    ...
    return imagesApiService.fetchImages().then((data)=>{
        buildGallery(data.hits);
        if (data.totalHits - (imagesApiService.page - 1) * 40 > 0) loadMoreBtn.enable();
        else {
            loadMoreBtn.hide();
            if (imagesApiService.page - 1 !== 1) (0, _notiflixNotifyAio.Notify).info("We're sorry, but you've reached the end of search results.");
        }
        return data;
    }).catch((err)=>{
        loadMoreBtn.hide();
...
function buildGallery(images) {
    const galleryMarkup = (0, _buildGalleryMarkup.buildGalleryMarkup)(images);
...
},{"./css/styles.css":"1CY4s","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","notiflix/build/notiflix-notify-aio":"eXQLZ","simplelightbox":"9ydBq","./js/ImagesApiService":"jHM9m","./js/LoadMoreButton":"g9qbx","./js/buildGalleryMarkup":"h0jen","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"kaxSc":[function() {},{}],"eXQLZ":[function(require,module,exports) {
var global = arguments[3];
/*
...
},{}],"jHM9m":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class ImagesApiService {
    ...
    async fetchImages() {
        ...
        return (0, _axiosDefault.default).get(`${URL_ORIGIN}?${searchParam}`).then((response)=>{
            if (response.status !== 200) return Promise.reject(`Error: ${response.message}`);
            if (!response.data.totalHits) return Promise.reject("Sorry, there are no images matching your search query. Please try again.");
            if (this.page === 1) (0, _notiflixNotifyAio.Notify).success(`Hooray! We found ${response.data.totalHits} images.`);
            this.incrementPage();
...
},{}],"g9qbx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class LoadMoreBtn {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h0jen":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "buildGalleryMarkup", ()=>buildGalleryMarkup);
